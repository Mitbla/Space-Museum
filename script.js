...
const museumData = {
    ...
    mars: {
        ...
        gallery: ["mars_premium_1773688810242.png", "mars_premium_1773688810242.png"] // Placeholders
    },
    jupiter: {
        title: "JUPITER",
        ...
        gallery: ["jupiter_premium_1773688823707.png", "jupiter_premium_1773688823707.png"] // Placeholders
    },
    saturn: {
        title: "SATURN",
        ...
        gallery: ["saturn_premium_1773689168077.png", "saturn_premium_1773689168077.png"] // Placeholders
    },
    uranus: {
        title: "URANUS",
        ...
        gallery: ["uranus_premium_1773689180697.png", "uranus_premium_1773689180697.png"] // Placeholders
    },
    neptune: {
        title: "NEPTUNE",
        ...
        gallery: ["neptune_premium_1773689193167.png", "neptune_premium_1773689193167.png"] // Placeholders
    }
};
...
const discoveryData = {
    webb: {
        title: "JAMES WEBB",
        description: "The James Webb Space Telescope (JWST) is the largest, most powerful, and most complex space science telescope ever built. It views the universe in the infrared, peering through dust clouds to see the formation of stars and planetary systems.",
        placeholderStyle: "linear-gradient(45deg, #1a0b2e, #0e1e2e)",
        link: "https://webb.nasa.gov/",
        imagePath: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c8/James_Webb_Space_Telescope_2022_telemetry.jpg/1280px-James_Webb_Space_Telescope_2022_telemetry.jpg" // Stable JWST rendering
    },
    perseverance: {
        title: "PERSEVERANCE",
        description: "NASA's Perseverance rover is exploring Jezero Crater on Mars, a site believed to have once been a flooded lakebed. Its mission is to seek signs of ancient life and collect rock and soil samples for possible return to Earth.",
        placeholderStyle: "linear-gradient(45deg, #2e100e, #3a150b)",
        link: "https://mars.nasa.gov/mars2020/",
        imagePath: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/92/Perseverance_Landing_on_Mars_-_Illustration_%28PIA23832%29.jpg/1280px-Perseverance_Landing_on_Mars_-_Illustration_%28PIA23832%29.jpg" // Stable Perseverance rendering
    },
    exoplanet: {
        title: "EXOPLANET K2-18B",
        description: "Recent atmospheric analysis of K2-18 b, an exoplanet 8.6 times as massive as Earth, has revealed the presence of carbon-bearing molecules including methane and carbon dioxide. This discovery adds to recent studies suggesting it could be a Hycean exoplanet, one which has the potential to possess a hydrogen-rich atmosphere and a water ocean-covered surface.",
        placeholderStyle: "linear-gradient(45deg, #0b1a2e, #0e2e2a)",
        link: "https://science.nasa.gov/universe/exoplanets/webb-discovers-methane-carbon-dioxide-in-atmosphere-of-k2-18-b/",
        imagePath: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/18/Exoplanet_K2-18b_%28artist%27s_impression%29.jpg/1280px-Exoplanet_K2-18b_%28artist%27s_impression%29.jpg" // Stable Exoplanet K2-18b representation
    }
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Initialize first image if data is missing from HTML
    if (planetImage) {
    ...
    if (discoveryImage && discoveryData.webb) {
        // Initialize Webb image
        discoveryImage.src = discoveryData.webb.imagePath;
